...
class MusicPlayerService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        intent?.let {
            when (intent.action) {
                ...
                STOP -> {
                    stopMusic() // Stop music if the stop action is triggered
                }
    ...
    fun stopMusic() {
        ...
        stopForeground(true) // Remove from the foreground service
    ...
    private fun sendNotification(track: Track) {
        ...
        val style = androidx.media.app.NotificationCompat.MediaStyle()
            .setShowActionsInCompactView(0, 1, 2, 3) // Show the stop button
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .addAction(R.drawable.ic_bt_account, "stop", createStopPendingIntent()) // Stop button
